  ...
  render() {
    return (
      <div className='signup'>
        ...
        <img style={{width:"900px",height:"715px"}} className='register_boy' src='../../intermediate.jpeg'/>
        </div>
        ...
        <h1 className="center-item" style={{fontFamily:"cursive", marginBottom:"35px", marginTop:"30px"}}>Manage Tutorial for Intermediates</h1>
          <form action='' style={{border:"solid"}}>
            ...
            <div className='input-container'>
              ...
              <input type='text-area' className='form-inputSignin' style={{fontFamily:"cursive"}} name='supName' onChange={this.haddleInputChanges} placeholder='Example'/>
            </div>
            <div className='input-container'>
